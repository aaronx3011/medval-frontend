...
export default function TopProductosMasVendidos({ data, isLoading }: Props) {
    const total = data.reduce((s, d) => s + d.value, 0);

    return (
        <GraphCard
            titlle='Top 5 productos más vendidos'
            graph={
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <PieChart
                                ...
                                sx={{
                                    [`& .${pieArcLabelClasses.root}`]: { fontSize: '10px', fontWeight: 700 },
                                    ...data.reduce((acc, d, i) => ({
                                        ...acc,
